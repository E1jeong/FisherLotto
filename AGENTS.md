...
Report plans and results in Korean; keep the owner-facing `README.md` in Korean, preserving code identifiers. Use the nearest module guide before changing a module.
