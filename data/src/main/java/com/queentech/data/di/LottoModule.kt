...
import com.queentech.data.usecase.lotto.GetLottoStatsUseCaseImpl
...
abstract class LottoModule {
    ...
    @Binds
    abstract fun bindGetLottoStatsUseCase(uc: GetLottoStatsUseCaseImpl): GetLottoStatsUseCase
